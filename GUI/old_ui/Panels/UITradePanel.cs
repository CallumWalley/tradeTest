...
public partial class UITradePanel : Control
{
    ...
    UIList<Industry> uiIndustryList;
    UIResourceList uiResourceList;
    //UIList uiStorageList;

    // UIDropDown uiTradeDestinationSelector;
    ...
    public void Init(Installation _installation)
    {
        ...
        // uiTradeDestinationSelector = p_uiTradeDestination.Instantiate<UIDropDown>();
        ...
        uiResourceList.Init(installation.delta);
        ...
        uiIndustryList = new();//p_vlist.Instantiate<UIContainers.UIListChildren>();
