...
public partial class UITradeRouteFull : Control, UIContainers.IListable<TradeRoute>
{
    ...
    UIResourceWithDetails friegherRequirement;
    ...
    public void Init(TradeRoute _tradeRoute)
    {
        ...
        friegherRequirement = GetNode<UIResourceWithDetails>("VBoxContainer/HBoxContainer/HSplitContainer/UIResource");
