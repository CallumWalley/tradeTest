...
public static partial class Resource
{
    ...
    public static Dictionary<int, ResourceType> _index = new Dictionary<int, ResourceType>(){
            {0, new ResourceType("Unset", GD.Load<Texture2D>("res://assets/icons/18x18/unity_grey.png"), false)},
            {1, new ResourceType("Minerals", GD.Load<Texture2D>("res://assets/icons/18x18/minerals.png"), true)},
